...
class ViewController: UIViewController {
    ...
    func askQuestion(action: UIAlertAction! = nil) {
        ...
        button1.setImage(UIImage(named: pokemonList[2]), forState: .Normal)
        button1.setImage(UIImage(named: pokemonList[3]), forState: .Normal)
        displayScore.text = String("Current Score: \(score)")
